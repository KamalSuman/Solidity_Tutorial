...
// tells that any version between the range is okay to work
contract simplestorage{
    ...
    mapping(string => uint256) public nameToage; // mapping ia a data structure int which a key points to a value . Here nameTopage becomes a dictionary that holds the key-value pair.
    ...
    // view, pure are the keywords in which you dont need to spend any gas
